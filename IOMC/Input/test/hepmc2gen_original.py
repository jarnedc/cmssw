...
#process.sexaqev = cms.EDFilter("PdgIdCandViewSelector",
#    src = cms.InputTag("genParticles"), 
#   pdgId = cms.vint32( 1020000020)
# )

process.antisexaqev = cms.EDFilter("CandViewSelector",
     src = cms.InputTag("genParticles"),
     cut = cms.string("pdgId = -1020000020")
)

process.sexaqevFilter = cms.EDFilter("CandViewCountFilter",
...
###################
process.p = cms.Path(process.genParticles * process.generatorSmeared * process.antisexaqev  * process.sexaqevFilter )
