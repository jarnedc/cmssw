...
config.General.requestName = 'SkimmingSexaqWithPU2016NeutrinoGun_tryToFix_8_trial11_'+day+'_'+version 
...
config.Data.outputPrimaryDataset = "CRAB_SimSexaqWithPU2016NeutrinoGun_tryToFix_8_trial11_"+day+"_"+version
