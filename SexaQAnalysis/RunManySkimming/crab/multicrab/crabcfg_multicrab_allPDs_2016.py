...
config.Site.blacklist = ['T1_DE_KIT','T2_GR_Ionnina','T2_IT_Legnaro','T1_UK_RAL','T1_RU_JINR','T1_FR_CCIN2D3','T2_IT_Bari','T2_IN_TIFR','T2_US_UCSD','T2_IT_frome','T2_BR_UERJ','T2_FR_GRIF_LLR','T1_FR_CCIN2P3']
...
ubmit_single_run("SingleMuon","Run2016B-07Aug17_ver2-v1")
