...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/crmc/Sexaquark_13TeV_trial7_Vtx_smeared/crmc_Sexaq_combined_trial7_Vtx_Smeared.root'),
    skipEvents = cms.untracked.uint32(214500),
...
#    fileName = cms.untracked.string('file:/user/jdeclerc/CMSSW_7_1_20_patch2/src/runGENSIM_Sexaq/sexaq_GENSIM_1_716.root'),
...
process.FEVToutput.outputCommands += ("keep *",)
