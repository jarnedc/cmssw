...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/crmc/Sexaquark_13TeV_trial4/crmc_Sexaq_combined.root'),
    skipEvents = cms.untracked.uint32(0),
...
process.VtxSmeared.Phi = 0.0
process.VtxSmeared.BetaStar = 65.0
process.VtxSmeared.Emittance = 5.411e-08
process.VtxSmeared.Alpha = 0.0
process.VtxSmeared.SigmaZ = 5.3
process.VtxSmeared.TimeOffset = 0.0
#process.X0 = cms.double(0.10482),
process.VtxSmeared.X0 = 10.10482
#process.Y0 = cms.double(0.16867),
process.VtxSmeared.Y0 = 10.16867
process.VtxSmeared.Z0 = -1.0985
...
process.smearing_step = cms.Path(process.VtxSmeared)
...
# Schedule definition
process.schedule = cms.Schedule(process.generation_step,process.smearing_step,process.genfiltersummary_step,process.simulation_step,process.endjob_step,process.RAWSIMoutput_step)
