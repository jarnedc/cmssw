...
# with command line options: Configuration/GenProduction/python/SUS-RunIISummer15GS-00146-fragment.py --filein=file:./SIMP_M100.lhe --fileout file:SIMP100_GENSIM.root --mc --eventcontent FEVT --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier FEVT --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --python_filename FEVT_test.py --no_exec -n 481
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(481)
)

# Input source
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:./SIMP_M100.lhe'),
...
process.FEVToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SIMP100_GENSIM.root'),
